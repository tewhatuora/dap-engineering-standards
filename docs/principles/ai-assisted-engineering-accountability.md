...
AI-Assisted Engineering Accountability establishes that engineering work produced or materially assisted by an AI tool is held to the same principles and standards, and the same human accountability, as work produced without AI assistance. It ensures AI adoption accelerates engineering delivery without diminishing responsibility or understanding for the resulting work.

## Principles

### Equal Application of Principles & Standards Regardless of Authorship

These principles hold AI-assisted work to every applicable principle and standard, to the same extent as human-authored work.
...
These principles keep the directing engineer accountable for AI-assisted work, across every kind of engineering artifact.
...
### Engineering Understanding as a Precondition for Use

These principles require an engineer to understand AI-assisted output well enough to explain and maintain it before adopting it.
...
These principles limit AI use to tooling sanctioned through the organisation's governance process.
...
These principles guard against the intellectual property and confidentiality risk AI-assisted work can introduce.
