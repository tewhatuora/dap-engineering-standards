...
Automation First establishes automation as the default approach for repeatable engineering and operational work. It reduces reliance on manual execution and directs engineering effort toward the design, judgement, and improvement work automation cannot replace.

## Principles

### Automating Repetitive Delivery Pipeline Tasks

These principles make automation the default approach for repeatable delivery pipeline work.
...
These principles extend automation to any repeatable engineering or operational task, not just the delivery pipeline.
...
### Automating Mechanical Checks Without Replacing Human Review

These principles automate mechanical, rule-based checks without reducing the human review and approval still required.
...
These principles direct teams to continually identify and automate repetitive operational work.
...
### Automation as a Maintained Engineering Artifact

These principles keep automation logic version-controlled and maintained like any other engineering artifact.
...
These principles reserve genuine human judgement for decisions automation cannot make.
...
### Exceptions Where Manual Process Remains Acceptable

These principles allow a manual step to remain where automation is not feasible or a deliberate checkpoint is required.
